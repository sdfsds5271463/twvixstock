...
<script setup lang="ts">
    ...
    let TD:TimelineStruct[] = [
        ...
        },
        {
            ...
            title: "體育遊戲系統",
            sub_title: "<b>自動部屬</b>超過<b>30個</b>微服務的<b>高併發</b>系統</p>",
            ...
            desc1: `
                ...
                系統架構包含平台、前端、後端、控端、賽程、訊源、視訊等，由<b>30個</b>以上的 GCP 容器微服務部屬整合運行，具備併發及自動拓展等特性，並確保整個系統具備高可用、高可靠、及可觀測。
            `,
            desc2: `
                本案在我們團隊接手之後，共分為三個時期：
                ...
                營運方面，我們提供 B2B 遊戲對接及訊源對接 (提供 WebSocket) 服務，並使用 Prometheus + Grafana + ELK + Tracing 觀測營運狀況。
            `,
        ...
        },
        {
            ...
            title: "獨立開發多款遊戲",
            sub_title: "從零到一完整獨立開發電子、百家樂、彩票系統",
            ...
            desc1: `
                ...
                2018 彩票遊戲，主體為基於彩票規則的爬蟲獎號概率精算遊戲。
                2019 區塊鏈百家樂，主體為 SHA512 預加密可驗證的公平紙牌機率遊戲，與著名遊戲平台合作，內崁為旗下遊戲之一。
                2020 電子遊戲，主體為精美的動畫與機率計算，內部崁入合作商捕魚遊戲。
            `,
            desc2: `
        ...
        },
        {
            ...
            title: "平台金流系統",
            sub_title: "平台金流系統合作<b>30個</b>以上金流商",
