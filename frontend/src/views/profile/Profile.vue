  ...
  <div class="container mx-auto">
    ...
    <BaseCard noPadding class="user-profile relative">
        <div class="header-cover">
          ...
          <div class="text-white text-center">全端工程師 / 技術主管 / Devops工程師</div>
        </div>
        <div class="flex justify-center z-10 -mt-10">
            <div class="text-center">
                ...
                <div class="profile_desc text-gray-600">
                  <p class="text-blue-500 font-extrabold"># PHP Laravel Golang Javascript Vue<br class="rwd"> DevOps GCP Docker Kubenetes</p>
                  <p>▪️<b>PHP</b>(13年) <b>Javascript</b>(13年) <b>Vue</b>(4年) <b>Docker</b>(4年) <br class="rwd"><b>Kubenetes</b>(4年) <b>Devops</b>(3年) <b>Golang</b>(2年)</p> 
                  <p>▪️13年全端經驗，擅長 <b>金流系統 / 平台開發 / <br class="rwd">高併發系統 / 架構設計 / 自動部屬</b></p> 
                  <p>▪️從傳統 VM 到自動部屬、GitOps 再到將 AI 引入 PR <br class="rwd">流程，管理30+個微服務的分散式系統</p>
